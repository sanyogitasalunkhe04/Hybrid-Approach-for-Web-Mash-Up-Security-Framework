				...
				<div class="span12">
					...
					<div class="row-fluid">
							<div class="span12">
								<table class="table table-bordered">
									...
									<?php
										...
										$result_users = $db->fetchQuery($sql_users);
										...
										<tr>
											...
											<td style="text-align: center">
														<a title="edit" href="<?php echo DOMAIN; ?>/user_panel/users/edit.php?id=<?php echo $value['id']; ?>"><i class="fa fa-edit"></i></a>
						...
						<div class="row-fluid" style="height: 30px;">
							<a class="btn btn-primary" href="<?php echo DOMAIN; ?>/user_panel/users/create.php">User registration</a>&nbsp;&nbsp;&nbsp;&nbsp;</span><a class="btn btn-primary" href="<?php echo DOMAIN; ?>/user_panel/dashboard.php"><i class="fa fa-reply"></i>&nbsp;&nbsp;Back</a>
						</div>
					</div>
				</div>
			</div>
