...
<html>
	<head>
		<title>User registration | Bug Tracker</title>
		<?php
			...
			if(isset($_POST['submit']))
			{
				...
				{
					if(isset($_POST['name']) && $_POST['name'] != "" && isset($_POST['uemail']) && $_POST['uemail'] != "" && isset($_POST['txt_password']) && $_POST['txt_password'] != "" && isset($_POST['gender']) && $_POST['gender'] != "" && isset($_POST['contact']) && $_POST['contact'] != "" && isset($_POST['address']) && $_POST['address'])
					{	
							$sql_user = "INSERT INTO `users`(`id`, `user_name`, `user_email`, `user_password`, `user_gender`, `user_contact_no`, `user_address`, `is_active`, `created_at`, `updated_at`) VALUES ('', :user_name, :user_email, :user_password, :user_gender, :user_contact_no, :user_address, :is_active, now(), now())";
						  	$flag = $db->queryPrepared($sql_user, array(':user_name' => htmlspecialchars($_POST['name']), ':user_email' => htmlspecialchars($_POST['uemail']), ':user_password' => md5($_POST['txt_password']), ':user_gender' => $_POST['gender'], ':user_contact_no' => $_POST['contact'], ':user_address' => htmlspecialchars($_POST['address']), ':is_active' => htmlspecialchars($_POST['is_active'])))->rowcount();
	...
	<body style="background-color: #222; color: #ffffff;">
		 <div class="container-fluid">
			...
			<div class="row-fluid grid_960_system">
					...
					<div class="row-fluid">
						<div class="span12">
				 			<h4><i class="fa fa-user"></i>&nbsp;&nbsp;User registeration</h4>
					...
					<form method = "post" enctype = "multipart/form-data" id = "frm_user" name = "frm_user">
						...
						<div class="row-fluid">
							<div class="span9">
								...
								<div class="row-fluid">
									<div class = "span3">
										<label for="txt_users_name">E-Mail:</label>
									</div>
									<div class="span9">
								...
								<div class="row-fluid">
									<div class = "span3">
										<label for="txt_users_name">Password :</label>
									</div>
									<div class="span9">
